...
let torontoData = "https://raw.githubusercontent.com/tfish110/Mapping_Earthquakes/main/torontoRoutes.json";
...
d3.json(torontoData).then(function(data) {
  ...
  L.geoJSON(data, {
    style: myStyle,
    onEachFeature: function(feature, layer) {
      layer.bindPopup("<h2> Airline: " + feature.properties.airline + "</h2> <hr><h3> Destionation: " + feature.properties.dst + "</h3>");
    }
  }).addTo(map);
});
